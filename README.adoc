...
ifndef::cloud-hosted[]
Now, you can check out the traces. Visit the http://localhost:9081/inventory/systems URL and then your Jaeger server at the http://localhost:16686 URL.
endif::[]

ifdef::cloud-hosted[]
Now, you can check out the traces. Run the following curl command:
```bash
curl -s http://localhost:9081/inventory/systems | jq
```
...
ifndef::cloud-hosted[]
Visit the http://localhost:9081/inventory/systems/localhost URL and then your Jaeger server at the http://localhost:16686 URL.
endif::[]
...
ifndef::cloud-hosted[]
Visit the http://localhost:9081/inventory/systems/unknown URL and then your Jaeger server at the http://localhost:16686 URL.
endif::[]
