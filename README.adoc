...
The recommended way to do this is to use a [hotspot=try file=0] `try-with-resources` block, which makes sure that the `Scope` is automatically closed at the end of the block.
