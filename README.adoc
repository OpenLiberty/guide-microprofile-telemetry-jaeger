...
For more information on these properties, see https://openliberty.io/docs/latest/microprofile-config-properties.html#telemetry[MicroProfile Telemetry Config properties^].
