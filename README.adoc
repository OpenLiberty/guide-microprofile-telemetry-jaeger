...
The diagram above depicts the architecture of the guide. Please note that the blue solid lines indicate the services included in the guide, while the dotted line represents services that can be added to the system.
