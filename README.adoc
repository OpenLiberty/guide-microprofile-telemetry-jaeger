...
Manually verify the traces by inspecting them on the Jaeger server. You will find some tests that are included to assess the basic functionality of the services. If any of the tests fail, it might indicate a potential bug in the code.
