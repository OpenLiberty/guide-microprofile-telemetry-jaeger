...
ifndef::cloud-hosted[]
Open a command-line session and navigate to the `finish` directory. Run the following Maven goal to build the `system` service and deploy it to Open Liberty:
