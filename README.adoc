...
MicroProfile Telemetry allows you to observe traces without modifying source code in your Jakarta RESTful web service (aka JAX-RS) applications.
You can enable [hotspot=mpTelemetry file=0]`mpTelemetry` feature in the `server.xml` of the `inventory` service.
