...
image::architecture_diagram.png[Application architecture^The blue solid lines indicate the services included in the guide, while the black dotted line represents services that can be added to the system.,align="center"]
